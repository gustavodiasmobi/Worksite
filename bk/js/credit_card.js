(function() {
				...
				return (
					(o = function(t) {
						...
						for (
							s = (function() {
								var t, a, i, o;
								for (o = [], t = 0, a = l.length; a > t; t++)
									(r = l[t]), (i = r.name), e.call(n.accept, i) >= 0 && o.push(r);
								return o;
							})(),
								a = 0,
								o = s.length;
							...
							if (((i = s[a]), t.match(i.pattern))) return i;
						return null;
					}),
					(c = function(e) {
						var t, n, a, r, i, l;
						for (a = 0, l = e.split('').reverse(), n = r = 0, i = l.length; i > r; n = ++r)
							(t = l[n]), (t = +t), n % 2 ? ((t *= 2), (a += 10 > t ? t : t - 9)) : (a += t);
						return a % 10 === 0;
					}),
					(s = function(t, n) {
						var a;
						return (a = t.length), e.call(n.valid_length, a) >= 0;
					}),
					(d = (function(e) {
						return function(e) {
							var t, n;
							return (
								...
								(n = !1),
								(t = !1),
								null != i && ((n = c(e)), (t = s(e, i))),
								{ card_type: i, valid: n && t, luhn_valid: n, length_valid: t }
							);
						};
					})(this)),
					(g = (function(e) {
					...
					a
						? (this.on(
								...
								(function(e) {
									return function() {
										return $(e).off('keyup.jccv'), t.call(e, g());
									};
								})(this)
							),
							this.on(
		...
		t = (function() {
			var t = /\blang(?:uage)?-(?!\*)(\w+)\b/i,
				n = (e.Prism = {
					util: {
						encode: function(e) {
							return e instanceof a
								? new a(e.type, n.util.encode(e.content))
								: 'Array' === n.util.type(e)
									? e.map(n.util.encode)
					...
					languages: {
						...
						insertBefore: function(e, t, a, r) {
							...
							for (var o in i)
								if (i.hasOwnProperty(o)) {
									if (o == t) for (var s in a) a.hasOwnProperty(s) && (l[s] = a[s]);
									l[o] = i[o];
								}
							return (r[e] = l);
						},
						DFS: function(e, t) {
							for (var a in e)
								t.call(e, a, e[a]), 'Object' === n.util.type(e) && n.languages.DFS(e[a], t);
						}
					},
						...
						if ((c && ((o = (c.className.match(t) || [ , '' ])[1]), (s = n.languages[o])), s)) {
							(r.className = r.className.replace(t, '').replace(/\s+/g, ' ') + ' language-' + o),
								...
								/pre/i.test(c.nodeName) &&
									(c.className = c.className.replace(t, '').replace(/\s+/g, ' ') + ' language-' + o);
							var u = r.textContent;
							if (u) {
								var g = { element: r, language: o, grammar: s, code: u };
								if ((n.hooks.run('before-highlight', g), i && e.Worker)) {
									...
									(d.onmessage = function(e) {
										...
										d.postMessage(JSON.stringify({ language: g.language, code: g.code }));
								} else
								...
								for (var d = 0; d < i.length; d++) {
									...
									if (!(p instanceof r)) {
										...
										if (f) {
											...
											k.push(w), b && k.push(b), Array.prototype.splice.apply(i, k);
										}
									}
								}
							}
					...
					hooks: {
						...
						run: function(e, t) {
							var a = n.hooks.all[e];
							if (a && a.length) for (var r = 0, i; (i = a[r++]); ) i(t);
						}
					}
				}),
			...
			if (
				((a.stringify = function(e, t, r) {
					...
					return (
						'<' + i.tag + ' class="' + i.classes.join(' ') + '" ' + l + '>' + i.content + '</' + i.tag + '>'
					);
				}),
				!e.document)
			)
	...
	'undefined' != typeof module && module.exports && (module.exports = t),
		...
		t.languages.markup &&
			t.languages.insertBefore('markup', 'tag', {
				script: {
					pattern: /<script[\w\W]*?>[\w\W]*?<\/script>/gi,
					inside: {
						tag: { pattern: /<script[\w\W]*?>|<\/script>/gi, inside: t.languages.markup.tag.inside },
		...
		$(function() {
			return (
				$('.credit_card .numbers li').wrapInner('<a href="#"></a>').click(function(e) {
					return (
						e.preventDefault(),
						$('.credit_card .numbers').slideUp(100),
						$('#card_number').val($(this).text()).trigger('input')
					);
				}),
				$('body').click(function() {
					return $('.credit_card .numbers').slideUp(100);
				}),
				$('.credit_card .numbers').click(function(e) {
					return e.stopPropagation();
				}),
				$('#sample-numbers-trigger').click(function(e) {
					return e.preventDefault(), e.stopPropagation(), $('.credit_card .numbers').slideDown(100);
				}),
				$('.credit_card .numbers').hide(),
				$('.vertical.maestro').hide().css({ opacity: 0 }),
				$('#card_number').validateCreditCard(
					function(e) {
						return (
							$(this).removeClass(),
							null == e.card_type
